...
class ApplicationMain {
	...
	private static function preload() {
		...
		// assets:
		loadBinary("assets/data/BaseMap.oel");
		loadBinary("assets/data/basemap1.oel");
		loadBinary("assets/data/data-goes-here.txt");
		loadBinary("assets/data/level_1.oel");
		loadBinary("assets/data/level_2.oel");
		loadBinary("assets/data/level_3.oel");
		loadBinary("assets/data/level_4.oel");
		loadBinary("assets/data/Mission1_0.oel");
		loadBinary("assets/data/Mission1_1.oel");
		loadBinary("assets/data/reachtshelden.oep");
		loadBinary("assets/data/room-001.oel");
		loadFile("assets/images/AngryDad.png");
		loadFile("assets/images/BigAssTiles.png");
		loadFile("assets/images/button.png");
		loadFile("assets/images/CharacterTilesheet768x768.png");
		loadFile("assets/images/coin.png");
		loadFile("assets/images/CollectingSpirit Kopie.png");
		loadFile("assets/images/enemy-0.png");
		loadFile("assets/images/enemy-1.png");
		loadFile("assets/images/enemy-2.png");
		loadFile("assets/images/Furniture.png");
		loadFile("assets/images/health.png");
		loadBinary("assets/images/images-go-here.txt");
		loadFile("assets/images/ion.png");
		loadFile("assets/images/Mission1Girl.png");
		loadFile("assets/images/Mission2Football.png");
		loadFile("assets/images/Mission3Emokid.png");
		loadFile("assets/images/NPCCharacterTilesheet.png");
		loadFile("assets/images/pat.png");
		loadFile("assets/images/player.png");
		loadFile("assets/images/pointer.png");
		loadFile("assets/images/SChool modified.png");
		loadFile("assets/images/street.PNG");
		loadFile("assets/images/SWAG-Kid-Walk-Kopie.png");
		loadFile("assets/images/tec.png");
		loadFile("assets/images/tiles.png");
		loadFile("assets/images/Tilesheet_Complete.png");
		loadBinary("assets/music/music-goes-here.txt");
		loadSound("assets/music/select.wav");
		loadSound("assets/music/townMusic.wav");
